...
const geometry = new THREE.DodecahedronGeometry(2, 0,4);
...
const material4 = new THREE.MeshDepthMaterial( { color: 0xffffff} );
const material5 = new THREE.MeshToonMaterial( { color: 0xffffff, flatShading: true} );
...
const geometry2 = new THREE.BoxGeometry( 20, 3, 3 );
...
function animate() {
    ...
    //mesh1.rotation.z += Math.random() / 100;
